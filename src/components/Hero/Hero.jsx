            ...
            <div className='heroContainer'>
                <div className='hero'>
                    ...
                    <div className='current'>
                        ...
                        <div className='currentAt'>Software Engineer at <a target={"_blank"} href="https://asymmetri.in/">Asymmetri.in</a></div>
                        <div className='currentWorking'>Working on <div target={"_blank"} href="https://github.com/tanishqkrk/wool">{'{null}'}</div></div>
                    </div>
