            ...
            //Experience
                ...
                <div className="experience__content"  >
                    <div className="experience__content--work">
                        <ExperienceWork desc={"Working on T3 stack, in a team of engineers and managers."} tools={["/ts.png", "/next.svg", "/tailwind.png"]} title={'Frontend Engineer'} link={"https://asymmetri.in/"} firm={'Asymmerti.in'} tenure={'April 2023 - Present'}></ExperienceWork>
