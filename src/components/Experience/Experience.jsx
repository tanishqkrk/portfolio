            ...
            //Experience
                ...
                <div className="experience__content"  >
                    <div className="experience__content--work">
                        <ExperienceWork desc={"Working on various JavaScript/TypeScript frameworks, in a team of engineers and managers. Building complex UIs and finding creative solutions for web based problems."} tools={["/ts.png", "js.png", "svelte.svg", "/next.svg", "/tailwind.png"]} title={'Frontend Engineer'} link={"https://asymmetri.in/"} firm={'Asymmerti.in'} tenure={'April 2023 - Present'}></ExperienceWork>
