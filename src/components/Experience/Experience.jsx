            ...
            //Experience
                ...
                <div className="experience__content"  >
                    <div className="experience__content--work">
                        <ExperienceWork desc={"I'm a JavaScript intern at Probooking, I've learnt a lot about the JS language and along with that finding creative solutions for UI challanges while working in a team of developers."} tools={["/vue.png", "/vuetify.png", "/js.png", "jquery.png", "bootstrap.png"]} title={'Front-end Intern'} firm={'getprobooking.com'} tenure={'March 2022 - Present'} link={'https://www.getprobooking.com/'}></ExperienceWork>
